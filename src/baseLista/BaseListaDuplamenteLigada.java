...
public class BaseListaDuplamenteLigada<X> {
    private class No {
        private X info;
        private No prox;
        private No ant;
    ...
    public BaseListaDuplamenteLigada() {
    ...
    public boolean equals (Object obj)
    {
        ...
        BaseListaDuplamenteLigada<X> lista =
        (BaseListaDuplamenteLigada<X>)obj;
    ...
    // construtor de copia
    public BaseListaDuplamenteLigada (BaseListaDuplamenteLigada<X> modelo) throws Exception
    {
        if (modelo==null)
    ...
    public Object clone ()
    {
        BaseListaDuplamenteLigada<X> ret=null;

        try
        {
            ret = new BaseListaDuplamenteLigada (this);
        }
