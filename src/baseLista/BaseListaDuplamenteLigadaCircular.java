...
public class BaseListaDuplamenteLigadaCircular<X> {
    private class No {
        X info;
        No prox, ant;
    ...
    public BaseListaDuplamenteLigadaCircular() {
    ...
    public boolean equals (Object obj)
    {
        ...
        BaseListaDuplamenteLigadaCircular<X> lista =
        (BaseListaDuplamenteLigadaCircular<X>)obj;
    ...
    // construtor de copia
    public BaseListaDuplamenteLigadaCircular (BaseListaDuplamenteLigadaCircular<X> modelo) throws Exception
    {
        if (modelo==null)
    ...
    public Object clone ()
    {
        BaseListaDuplamenteLigadaCircular<X> ret=null;

        try
        {
            ret = new BaseListaDuplamenteLigadaCircular (this);
        }
